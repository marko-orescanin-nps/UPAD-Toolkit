#!/bin/bash
#SBATCH --output=outputs/split_15_0_mc.out
#SBATCH --time=10:00:00
#SBATCH --partition=kraken
#SBATCH --nodelist=compute-9-34

python -m split.split --records_dir '/thumper/users/kraken/ais_data_labeling/multilabel_tfrecords/MarineCadastre/15_0/' \
