#!/bin/bash
#SBATCH --output=outputs/split_7.5_0_mc.out
#SBATCH --partition=kraken
#SBATCH --nodelist=compute-9-34

python -m split.split --records_dir '/thumper/users/kraken/ais_data_labeling/multilabel_tfrecords/MarineCadastre/7.5_0/' \
