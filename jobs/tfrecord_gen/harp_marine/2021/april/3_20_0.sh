#!/bin/bash
#SBATCH --output=outputs/harp_marine/tfrecord_gen_april_3_20_0_2021.out \
...
--wav_fmt 'harp' \
--tfrecord_dir '/thumper/users/kraken/ais_data_labeling/multilabel_tfrecords/MarineCadastre/20_0/' \
--detect_range 20 \
--buffer_range 0 \
