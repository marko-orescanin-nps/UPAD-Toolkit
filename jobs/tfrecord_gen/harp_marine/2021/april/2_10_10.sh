#!/bin/bash
#SBATCH --output=outputs/harp_marine/tfrecord_gen_april_2_10_10_2021.out \
...
--wav_fmt 'harp' \
--tfrecord_dir '/thumper/users/kraken/ais_data_labeling/multilabel_tfrecords/MarineCadastre/10_10/' \
--detect_range 10 \
--buffer_range 10 \
--start "20210410 000000" \
--end "20210420 000000" \
