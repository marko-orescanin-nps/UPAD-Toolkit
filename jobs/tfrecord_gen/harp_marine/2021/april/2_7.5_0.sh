#!/bin/bash
#SBATCH --output=outputs/harp_marine/tfrecord_gen_april_2_7.5_0_2021.out \
...
--wav_fmt 'harp' \
--tfrecord_dir '/thumper/users/kraken/ais_data_labeling/multilabel_tfrecords/MarineCadastre/7.5_0/' \
--detect_range 7.5 \
--buffer_range 0 \
