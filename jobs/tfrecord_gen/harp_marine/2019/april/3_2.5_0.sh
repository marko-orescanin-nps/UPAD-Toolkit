#!/bin/bash
#SBATCH --output=outputs/harp_marine/tfrecord_gen_april_3_2.5_0_2019.out \
...
--wav_fmt 'harp' \
--tfrecord_dir '/thumper/users/kraken/ais_data_labeling/multilabel_tfrecords/MarineCadastre/2.5_0/' \
--detect_range 2.5 \
--buffer_range 0 \
