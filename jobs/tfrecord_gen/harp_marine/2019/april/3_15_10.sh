#!/bin/bash
#SBATCH --output=outputs/harp_marine/tfrecord_gen_april_3_15_10_2019.out \
...
--wav_fmt 'harp' \
--tfrecord_dir '/thumper/users/kraken/ais_data_labeling/multilabel_tfrecords/MarineCadastre/15_10/' \
--detect_range 15 \
--buffer_range 10 \
--start "20190420 000000" \
--end "20190501 000000" \
